...
class DrawingTextRectItem(DrawingRectItem):
    ...
    def _calculateTextRect(self, font: QFont) -> QRectF:
        if (self.isValid()):
            ...
            return QRectF(-textWidth / 2, -textHeight / 2, textWidth, textHeight).translated(self._rect.center())
        return QRectF()
